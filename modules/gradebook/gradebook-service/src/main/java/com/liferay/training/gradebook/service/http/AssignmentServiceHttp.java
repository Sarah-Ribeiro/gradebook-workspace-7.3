...
public class AssignmentServiceHttp {
	...
	public static long getAssigmentsCountByKeywords(
		...
		try {
			MethodKey methodKey = new MethodKey(
				AssignmentServiceUtil.class, "getAssigmentsCountByKeywords",
				_getAssigmentsCountByKeywordsParameterTypes2);
	...
	private static final Class<?>[]
		_getAssigmentsCountByKeywordsParameterTypes2 = new Class[] {
